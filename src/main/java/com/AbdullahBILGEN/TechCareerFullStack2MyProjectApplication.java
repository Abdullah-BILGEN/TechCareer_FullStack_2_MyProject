...
public class TechCareerFullStack2MyProjectApplication {
	...
	public static void main(String[] args) {
		...
		SpringApplication.run(TechCareerFullStack2MyProjectApplication.class, args);
	}
